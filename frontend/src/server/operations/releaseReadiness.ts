export const releaseReadinessChecks = [
  {
    ...
    detail: "Production deploys require Supabase, provider, app URL, onchain, and social/search configuration before build.",
  },
  {
  ...
  },
  {
    ...
    detail: "The deployed URL must pass health, agent, scan, decision, and execution prepare smoke checks.",
  },
  {
    title: "Rollback plan",
