...
/**
 * Constructs a canonical subject identity key distinguishing chain, symbol, and contract/issuer.
 *
 * @param subject Subject descriptor of the claim
 * @returns Canonical compound string identity key
 */
...
/**
 * Evaluates coverage, family independence, redundancy, and agreement for a claim.
 *
 * @param claim Target claim definition
 * @param observations Observations associated with the claim
 * @param contradictions Contradictions identified for this claim
 * @param agreeingPairCount Number of comparable pairs in agreement
 * @returns Complete coverage assessment for the claim
 */
