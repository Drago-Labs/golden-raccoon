...
/**
 * Checks whether an object key name matches known secret or credential substrings.
 *
 * @param key Property key to evaluate
 * @returns True if the key indicates sensitive credentials or tokens
 */
...
/**
 * Generates an audit note explaining dropped provider fields.
 *
 * @param result Redaction result details
 * @returns Human-readable summary of redacted fields
 */
