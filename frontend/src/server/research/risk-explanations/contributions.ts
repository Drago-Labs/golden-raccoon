...
function classify(entry: IndexedFactor): ExplanationContributionKind {
  // A factor with a zero impact and a neutral direction records no magnitude;
  // it exists to describe context, and calling it "scored" would invite readers
  // to treat 0 as a measured contribution.
