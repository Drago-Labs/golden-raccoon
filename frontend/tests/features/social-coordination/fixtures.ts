...
export const synchronizedCopyBurst: CoordinationRequest = {
  ...
  observations: [
    // Quiet baseline spread across earlier windows.
    ...
    // The burst: one window, four accounts, identical text.
...
export const duplicatesMalformedHostile: CoordinationRequest = {
  ...
  observations: [
    ...Array.from({ length: 14 }, (_, index) => ({
      ...
      // One account posting fourteen times must stay one participant.
